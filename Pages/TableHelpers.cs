...
namespace SSD.Pages {
    class TableHelpers {
            ...
            public static void RenderTable(Transactions[] transactions)
            {
                AddLine();
            ...
            private static void AddRow(string val1, string val2, string val3, string val4, string val5, string val6)
            {
